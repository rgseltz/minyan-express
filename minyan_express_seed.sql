...
INSERT INTO locations (nick_name, street_name, street_number, city, zip, is_public, location_capacity_limit) 
...
('waldorf-jerusalem', 'Gershon Agron Street', '26-28', 'Jerusalem', 9419008, 'true', 30),
('ritz-hertzliya', 'Ha-Shunit Street', '4', 'Herzliya', 4655202, 'true', 30);
